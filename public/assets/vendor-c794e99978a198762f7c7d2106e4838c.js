...
var r=Ember.RSVP.Promise,i="undefined"!=typeof jQuery?jQuery:void 0
function o(e,t,n,i){var o
try{o=e.handleResponse(i.status,i.headers,t,n)}catch(a){return r.reject(a)}return o&&o.isAdapterError?r.reject(o):o}function a(e,t,r,i){var o
...
else try{o=e.handleResponse(i.status,i.headers,t||i.errorThrown,r)}catch(a){o=a}return o}function s(e){return{status:e.status,textStatus:e.textStatus,headers:l(e.headers)}}function u(e){return{status:e.status,textStatus:e.statusText,headers:(0,n.parseResponseHeaders)(e.getAllResponseHeaders())}}function l(e){var t={}
return e&&e.forEach(function(e,n){return t[n]=e}),t}function c(e,t){if(e.credentials="same-origin",e.data)if("GET"===e.method||"HEAD"===e.method){if(Object.keys(e.data).length){var r=e.url.indexOf("?")>-1?"&":"?"
...
return!1===(e&&e._JQUERY_INTEGRATION)||void 0===i}),sortQueryParams:function(e){var t=Object.keys(e),n=t.length
if(n<2)return e
...
default:if(e>=500)return new n.ServerError(o,a)}return new n.AdapterError(o,a)},isSuccess:function(e,t,n){return e>=200&&e<300||304===e},isInvalid:function(e,t,n){return 422===e},ajax:function(e,t,i){var l=this,c=Ember.get(this,"useFetch"),h={url:e,method:t},f=l.ajaxOptions(e,t,i)
...
if(t.ok)return function(e,t,n,r){var i=s(n)
return o(e,t,r,i)}(l,n,t,h)
throw function(e,t,n,r,i){var o=s(n)
return o.errorThrown=r,a(e,t,i,o)}(l,n,t,null,h)}):new r(function(e,t){f.success=function(t,n,r){var i=function(e,t,n,r){var i=u(n)
return o(e,t,r,i)}(l,t,r,h)
Ember.run.join(null,e,i)},f.error=function(e,n,r){var i=function(e,t,n,r){var i=u(t)
i.errorThrown=n
var o=e.parseErrorResponse(t.responseText)
return a(e,o,r,i)}(l,e,r,h)
Ember.run.join(null,t,i)},l._ajax(f)},"DS: RESTAdapter#ajax "+t+" to "+e)},_ajaxRequest:function(e){i.ajax(e)},_najaxRequest:function(e){if("undefined"==typeof najax)throw new Error("najax does not seem to be defined in your app. Did you override it via `addOrOverrideSandboxGlobals` in the fastboot server?")
...
n.headers["content-type"]=i}return(n=Ember.get(this,"useFetch")?c(n,this):function(e,t){e.dataType="json",e.context=t,e.data&&"GET"!==e.type&&(e.data=JSON.stringify(e.data),e.contentType="application/json; charset=utf-8")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default="3.9.2"}),define("ember-inflector/index",["exports","ember-inflector/lib/system","ember-inflector/lib/ext/string"],function(e,t){"use strict"
